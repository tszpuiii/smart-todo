...
const MESSAGES = {
  en: {
    app_name: 'Smart To Do Apps',
    app_name_short: 'Smart To Do',
    energy_group: 'MATCH MY ENERGY',
    energy_low: 'Low energy / Admin',
    energy_low_short: 'Low',
    energy_medium: 'Medium focus',
    energy_medium_short: 'Medium',
    energy_high: 'Deep focus / Strategy',
    energy_high_short: 'Deep',
    form_energy: 'Energy needed',
    form_energy_auto_hint: 'Auto-detected from title — change anytime',
    form_priority: 'Priority',
    priority_high: 'High priority',
    priority_high_short: 'High',
    priority_medium: 'Medium priority',
    priority_medium_short: 'Med',
    priority_low: 'Low priority',
    priority_low_short: 'Low',
    sorted_by_priority: 'Sorted by priority & due date — top item suggested first',
    start_here: 'Start here',
    energy_wip_warning: 'You have {count} high-focus tasks in Doing. Consider finishing one before starting another.',
    header_today: 'Today',
  ...
  'zh-Hant': {
    ...
    energy_low_short: '低',
    energy_medium: '中等專注',
    energy_medium_short: '中',
    energy_high: '深度專注 / 策略',
    energy_high_short: '高',
    form_energy: '所需精力',
    form_energy_auto_hint: '已依標題自動判斷 — 可隨時手動更改',
    form_priority: '重要度',
    priority_high: '高重要',
    priority_high_short: '高',
    priority_medium: '中等重要',
    priority_medium_short: '中',
    priority_low: '低重要',
    priority_low_short: '低',
    sorted_by_priority: '依重要度與截止日排序 — 建議從最上方開始',
    start_here: '建議先做',
    energy_wip_warning: 'Doing 欄已有 {count} 個高能耗任務，建議先收尾一個再開新戰線。',
    header_today: '今天',
