...
After the base filter, I reduced creation friction: if you are already in the Low energy view, new tasks default to low energy; titles with admin verbs (e.g. “Reply”, “Email”) auto-suggest 🟢, while strategy verbs (e.g. “Write PRD”, “Plan”) suggest 🔴. On the Kanban board, cards show a colored left border by energy, and a gentle warning appears when more than two high-focus tasks sit in Doing at once.
